  ...
  switch npc_nome{
   ...
   switch npc_nome{
     ...
     switch npc_nome{
	  ...
	  case "Espelho":
	  ds_grid_add_text("Por algum motivo eu não consigo me ver nessas coisas, parece preguiça do criador eu não me ver nisso. Talvez eu seja um vampiro",Spr_retrado_yuki_normal,0,"Yuki")
	  break;
   ...
   switch npc_nome{
	  ...
	  case "Cama":
	  ds_grid_add_text("Minha cama, o lugar onde encontro descanso e paz. Mas estou tendo pesadelos recorrentes com fogo . . . muito fogo.",Spr_retrado_yuki_normal,0,"Yuki")
	  break;
   ...
   switch npc_nome{
	  ...
	  case "Poster":
	  ds_grid_add_text("Barvel vs Pc A luta sobre heróis e computadores malignos.",Spr_retrado_yuki_normal,0,"Yuki")
	  break;
...
switch (npc_nome)
{
    ...
    case "porta_tyler_trancada":
        ds_grid_add_text("Está trancado...", Spr_retrado_yuki_normal, 0, "Yuki");
        ds_grid_add_text("Preciso da chave do quarto do Tyler.", Spr_retrado_yuki_normal, 0, "Yuki");
        break;
        
    case "porta_saida_trancada":
        ds_grid_add_text("A porta da frente está trancada.", Spr_retrado_yuki_normal, 0, "Yuki");
        ds_grid_add_text("Preciso de encontrar a chave para sair.", Spr_retrado_yuki_normal, 0, "Yuki");
        break;
        
    case "apanhei_chave_tyler":
        ds_grid_add_text("Apanhei a chave do quarto do Tyler.", Spr_retrado_yuki_normal, 0, "Sistema");
        break;
        
    case "apanhei_chave_casa":
        ds_grid_add_text("Esta deve ser a chave da porta da frente.", Spr_retrado_yuki_normal, 0, "Sistema");
        break;
}
