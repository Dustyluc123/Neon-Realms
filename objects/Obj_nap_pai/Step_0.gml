// --- CÓDIGO FINAL COMPLETO para o evento STEP de obj_nap_pai ---
...
switch (estado_pai)
{
    ...
    case PAI_ESTADO.ZOOM_OUT:
        ...
        // CORREÇÃO: Prende a câmera nos 4 cantos da sala
    ...
    case PAI_ESTADO.INDO_PONTO_A:
        sprite_index = npc_pai; // Substitua pela sua sprite
    ...
    case PAI_ESTADO.INDO_PONTO_C:
        sprite_index = npc_pai; // Substitua pela sua sprite
        mp_linear_step(380, 50, velocidade_pai, false);
    ...
    case PAI_ESTADO.ZOOM_IN:
        ...
        var _centro_x_final = cam_x_original + (cam_w_original / 2);
        var _centro_y_final = cam_y_original + (cam_h_original / 2);
